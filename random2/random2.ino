...
void drawFrame(int pcnt){
  ...
  for(unsigned char x=0;x<ColorduinoScreenHeight;x++) {
      colorHSV.h = (unsigned char)(((100.0-pcnt)*matrix[x][0].h + pcnt*line[x].h)/100.0);
      colorHSV.s = (unsigned char)(((100.0-pcnt)*matrix[x][0].s + pcnt*line[x].s)/100.0);
      colorHSV.v = (unsigned char)(((100.0-pcnt)*matrix[x][0].v + pcnt*line[x].v)/100.0);
